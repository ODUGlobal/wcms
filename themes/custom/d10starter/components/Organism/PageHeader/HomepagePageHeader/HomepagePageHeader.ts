/*
  ...
  `../HeroPageHeader/HeroPageHeader.ts` (EXCEPT for the values of `VIDEO_WRAPPER_ID`,
...
*/
const setUpHomepagePageHeader = () => {
  const VIDEO_WRAPPER_ID = 'home-header-ambient-video';
  ...
  const setUpVideo = () => {
    const VIDEO_BUTTON_ID = 'home-header-video-button';
    const HERO_OVERLAY_ID = 'home-header-overlay';
    ...
    const VIDEO_WRAPPER_CONTAINER_ID = 'home-header-ambient-video-container';
...
if (!window.IS_STORYBOOK) setUpHomepagePageHeader();

export default setUpHomepagePageHeader;
