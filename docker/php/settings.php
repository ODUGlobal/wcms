...
// Set the config dir. This changed in 8.8.0.
$settings['config_sync_directory'] = 'sites/default/files/config';

// Set a default private path that corresponds to Pantheon's preferred location.
$settings['file_private_path'] = 'sites/default/files/private';

// Temp path.
$settings['file_temp_path'] = '/tmp';

// Exclude devlepment modules from config export
